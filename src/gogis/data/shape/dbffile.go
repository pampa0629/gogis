...
// func dbfTypeConvertor2(dtype byte) data.FieldType {
...
// 	DbfHeader
// 	FieldNum   int              // 字段个数
// 	fieldInfos []data.FieldInfo // 字段信息
...
// 	this.fieldInfos = make([]data.FieldInfo, this.FieldNum)
...
// func (this *DbfFile) dbfString2Value2(data []byte, ftype data.FieldType) (v interface{}) {
// 	switch ftype {
